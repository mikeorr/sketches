...
const CARD_BACK = "\u{1F0A0}";   // PLAYING CARD BACK character.
...
class SpysolModel {
    ...
    clear() {
        this.rows = [ [], [], [], [], [], [], [], [], [], [] ];
        this.reserve = [  4,  4,  4,  4,  3,  3,  3,  3,  3,  3 ];
        this.stock = [];
        this.foundation = [];
        this.won = false;
    ...
    newGame() {
        ...
        if (deal_by_row) {
            ...
            this.rows[0] = cards.splice(0, 5);
            this.rows[1] = cards.splice(0, 5);
            this.rows[2] = cards.splice(0, 5);
            this.rows[3] = cards.splice(0, 5);
            this.rows[4] = cards.splice(0, 4);
            this.rows[5] = cards.splice(0, 4);
            this.rows[6] = cards.splice(0, 4);
            this.rows[7] = cards.splice(0, 4);
            this.rows[8] = cards.splice(0, 4);
            this.rows[9] = cards.splice(0, 4);
        }
        this.stock = cards;
    ...
    move(dst) {
        ...
        this.reserve[src] = Math.max(this.rows[src].length - 1, 0);
        this.selection.clear();
...
function renderTableau(listenCards, listenRows) {
    ...
    for (r = 0; r < model.rows.length; r++) {
        ...
        for (i = 0; i < model.rows[r].length; i++) {
            ...
            /*
            if (model.isCardReserve(r, i)) {
                classes.push("reserve");
            }
            */
...
function renderStock() {
    ...
    DOM.stock_cards.innerHTML = CARD_BACK.repeat(size);
}
...
function init() {
    if (!initialized) {
        ...
        DOM.stock_cards = document.getElementById("stock-cards");
